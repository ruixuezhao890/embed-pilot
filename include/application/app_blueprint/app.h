...
namespace ep_application{
    ...
    protected:
        ...
        bool clear_the_previous_screen_= true;
    protected:
        virtual void screen_init_function()=0;
    public:
        void set_screen_init_function(bool set){
            clear_the_previous_screen_=set;
        }
        ...
        void on_create(){
            ...
            if(clear_the_previous_screen_){
                lv_obj_clean(screen_obj_t);
            }
    ...
    public:
        ...
        virtual void set_whether_the_previous_screen_is_cleared(){}
